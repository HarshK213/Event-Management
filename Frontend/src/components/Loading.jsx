...
const styles = {
  sm: { root: "gap-4", label: "text-sm font-medium", spinner: "w-8 h-8" },
  md: { root: "gap-4", label: "text-sm font-medium", spinner: "w-12 h-12" },
  lg: { root: "gap-4", label: "text-lg font-medium", spinner: "w-14 h-14" },
  xl: { root: "gap-5", label: "text-lg font-medium", spinner: "w-16 h-16" },
};
